...
1. Unduh `DompetAjaib_v20260925_59.zip` dari percakapan ke laptop kantor. Cukup unduh, tidak perlu ekstrak.
...
4. Di terminal Cloud Shell, salin dan jalankan:
   ...
   ```bash
   cd ~
   unzip -o DompetAjaib_v20260925_59.zip
   cd dompet-ajaib
...
1. Unduh ZIP **baru** `DompetAjaib_v20260925_59.zip` dari percakapan. Jangan pakai ZIP lama yang namanya mirip.
