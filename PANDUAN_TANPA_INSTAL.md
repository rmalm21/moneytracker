...
1. Unduh `Dompet_Ajaib_Tampilan_Rapi_24Sep2026.zip` dari percakapan ke laptop kantor. Cukup unduh, tidak perlu ekstrak.
...
4. Di terminal Cloud Shell, salin dan jalankan:
   ...
   ```bash
   cd ~
   unzip -o Dompet_Ajaib_Tampilan_Rapi_24Sep2026.zip
   cd dompet-ajaib
...
1. Unduh ZIP **baru** `Dompet_Ajaib_Tampilan_Rapi_24Sep2026.zip` dari percakapan. Jangan pakai ZIP lama yang namanya mirip.
