  ...
  },
  {
    ...
    items: [
      { id: 'm-home', q: 'Beranda', a: 'Ringkasan keuanganmu: uang bebas, sisa anggaran, pemasukan, pengeluaran, transaksi terbaru, grafik kategori, saldo dompet, pemasukan & pengeluaran per kategori, dan proyeksi.', children: [
        { id: 'm-home-edit', q: 'Mengatur kartu di Beranda', keywords: 'widget tambah kartu dashboard', a: 'Ketuk tombol **Atur Beranda** (ikon pengaturan di pojok kartu atas), lalu **Tambah kartu**. Ada lebih dari 40 kartu yang dikelompokkan — mulai dari angka ringkas, kantong, dana darurat, belanja 7 hari, pengeluaran terbesar, tagihan rutin, sampai siklus lalu. Kartu bisa disembunyikan atau digeser urutannya, dan semuanya terbuka saat Beranda dibuka. Periode Beranda bisa diganti di pilihan **Periode**.' },
