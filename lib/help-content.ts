...
export const helpGroups: HelpGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'start-first-tx', q: 'Bagaimana mencatat transaksi pertama?', a: 'Tekan tombol **+** (di tengah bawah pada HP, atau **Catat transaksi** di kanan atas pada komputer). Pilih **Keluar**, **Masuk**, atau **Transfer**, isi nominal, pilih kategori dan dompet, lalu **Simpan**.', tip: 'Kategori yang sering dipakai muncul sebagai pilihan cepat di atas daftar kategori.' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 't-kantong', q: 'Kantong', a: 'Kelompok dompet untuk satu tujuan, misalnya **Dana darurat = Mandiri + BRI**. Saldo kantong otomatis sama dengan total saldo dompet di dalamnya, dan dompet itu tidak dihitung sebagai uang bebas.', go: { view: 'wallets', label: 'Buka Dompet' } },
      ...
      { id: 't-claim', q: 'Talangan & klaim kantor', a: '**Talangan kantor** adalah uang pribadimu yang dipakai dulu untuk keperluan kantor. Setelah diganti, catat sebagai **Klaim cair**. Klaim yang ditolak dicatat sebagai pengeluaran.' },
      { id: 't-receivable', q: 'Piutang', a: 'Uang yang kamu pinjamkan ke orang lain dan belum kembali (**Talangan teman**). Bisa dilunasi lewat dompet, atau ditandai lunas tanpa dompet kalau dibayar tunai yang tidak dicatat.' },
      ...
      { id: 't-budget-types', q: 'Jenis anggaran', a: '**Kebutuhan** untuk belanja sehari-hari, **Tagihan tetap** untuk yang nominalnya pasti, **Tujuan dana** untuk menyisihkan rutin, dan **Tabungan** untuk setoran tabungan. Anggaran bisa per siklus gaji, per bulan, per minggu, atau mulai tanggal tertentu.', children: [
        { id: 't-rollover', q: 'Sisa dibawa ke periode berikutnya?', a: 'Kalau dicentang, sisa anggaran (atau kelebihannya) ikut ke periode berikutnya. Cocok untuk pos yang tidak rutin tiap bulan.' },
      ] },
      ...
      { id: 't-idle', q: 'Uang menganggur', a: 'Uang di atas kebutuhan sampai gajian, cadangan, dan target dana darurat. Insight menyarankan ke mana bisa dipindahkan sesuai profil risikomu.' },
  ...
  },
  {
    ...
    items: [
      { id: 'm-home', q: 'Beranda', a: 'Ringkasan keuanganmu: uang bebas, sisa anggaran, pemasukan, pengeluaran, transaksi terbaru, grafik kategori, saldo dompet, pemasukan & pengeluaran per kategori, dan proyeksi.', children: [
        { id: 'm-home-edit', q: 'Mengatur kartu di Beranda', a: 'Ketuk **Atur Beranda** di kartu atas, lalu tambah, sembunyikan, atau geser urutan kartu. Periode Beranda bisa diganti di pilihan **Periode**.' },
      ...
      { id: 'm-budget', q: 'Anggaran', a: 'Batas belanja per kategori. Kartu menunjukkan yang masih bisa dipakai, yang sudah terpakai, dan yang direncanakan. **Buka rincian** menampilkan laju belanja per hari dan per minggu.', go: { view: 'budgets', label: 'Buka Anggaran' } },
      ...
      { id: 'm-categories', q: 'Kategori', a: 'Daftar kategori dan subkategori pemasukan dan pengeluaran, lengkap dengan ikon dan warna. Kategori yang tidak dipakai bisa digabung atau diarsipkan.', go: { view: 'categories', label: 'Buka Kategori' } },
      { id: 'm-settings', q: 'Pengaturan', a: 'Semua pengaturan aplikasi.', children: [
        ...
        { id: 'm-set-security', q: 'Keamanan', a: 'PIN 4 angka, buka dengan sidik jari atau wajah (di aplikasi yang dipasang), dan ganti password.', go: { view: 'settings', label: 'Buka Keamanan', target: 'security' } },
  ...
  },
  {
    ...
    items: [
      { id: 'h-transfer', q: 'Mencatat transfer antardompet', a: 'Pilih **Transfer** di form transaksi, isi nominal, pilih dompet asal dan tujuan. Kalau ada biaya admin, isi di bagian lainnya dan pilih kategorinya — biaya itu dihitung sebagai pengeluaran.' },
      { id: 'h-split', q: 'Satu transaksi untuk beberapa kategori', a: 'Di form pengeluaran, buka bagian lainnya lalu gunakan **pembagian**: isi nominal untuk tiap kategori sampai jumlahnya sama dengan total transaksi.' },
      { id: 'h-correct', q: 'Saldo di aplikasi berbeda dengan saldo asli', a: 'Buka **Dompet**, ketuk **⋯ → Cocokkan saldo**, lalu isi saldo aslinya. Aplikasi mencatat selisihnya sebagai koreksi. Kalau curiga ada transaksi yang terlewat, cek dulu riwayat transaksinya.', go: { view: 'wallets', label: 'Buka Dompet' } },
      ...
      { id: 'h-recurring', q: 'Mengatur tagihan rutin', a: 'Di **Jadwal → Rutin → Jadwal baru**, isi nama, nominal, dompet, frekuensi, dan tanggal berikutnya. Lalu pilih perilakunya:', children: [
      ...
      { id: 'h-reorder', q: 'Menggeser urutan dompet, anggaran, atau kartu', a: 'Di HP, **tahan sebentar** pegangan titik-titik di kiri sampai kartunya terangkat, lalu geser. Di komputer, langsung tarik pegangannya.' },
      ...
      { id: 'h-lock', q: 'Mengunci aplikasi dengan PIN atau sidik jari', a: 'Buka **Pengaturan → Keamanan**, buat PIN 4 angka. Setelah aplikasi dipasang ke layar utama, sidik jari atau wajah bisa diaktifkan untuk membuka kunci.', go: { view: 'settings', label: 'Buka Keamanan', target: 'security' } },
      { id: 'h-install', q: 'Memasang aplikasi ke layar utama', a: 'Buka **Pengaturan → Aplikasi di perangkat**, lalu ikuti tombol pasang. Setelah terpasang, aplikasi terbuka seperti aplikasi biasa dan bisa dipakai saat offline.', go: { view: 'settings', label: 'Buka Aplikasi di perangkat', target: 'app' } },
      { id: 'h-backup', q: 'Mencadangkan dan memulihkan data', a: 'Di **Pengaturan → Data & cadangan**, tekan **Unduh cadangan** untuk menyimpan file. Untuk memulihkan, pilih file cadangan lalu pilih gabungkan atau ganti semua data.', go: { view: 'settings', label: 'Buka Data & cadangan', target: 'data' } },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'f-notif', q: 'Notifikasi tidak muncul sebagai pop-up', a: 'Pastikan izin notifikasi aplikasi aktif. Di Android, buka pengaturan notifikasi aplikasi dan izinkan tampil sebagai pop-up. Coba dengan tombol **Coba kirim** di **Pengaturan → Pengingat**.', go: { view: 'settings', label: 'Buka Pengingat', target: 'reminders' } },
