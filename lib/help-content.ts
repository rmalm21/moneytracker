...
export const helpGroups: HelpGroup[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'm-home', q: 'Beranda', a: 'Ringkasan keuanganmu: uang bebas, sisa anggaran, pemasukan, pengeluaran, transaksi terbaru, grafik kategori, saldo dompet, pemasukan & pengeluaran per kategori, dan proyeksi.', children: [
        { id: 'm-home-edit', q: 'Mengatur kartu di Beranda', keywords: 'widget tambah kartu dashboard', a: 'Ketuk tombol **Atur Beranda** (ikon pengaturan di pojok kartu atas), lalu **Tambah kartu**. Ada 41 kartu dalam 9 kategori (misalnya Uang bebas & gajian, Aset & dompet, Analisis belanja, Jadwal & rencana). Ketuk kategori untuk membukanya, atau cari lewat kotak **Cari kartu**. Daftar tetap terbuka, jadi beberapa kartu bisa ditambah sekaligus. Kartu bisa disembunyikan atau digeser urutannya, dan semuanya terbuka saat Beranda dibuka. Periode Beranda bisa diganti di pilihan **Periode**.' },
      ...
      { id: 'm-debts', q: 'Utang & Piutang', a: 'Tiga tab: **Utang** (pinjaman dan cicilan), **Piutang** (uang yang dipinjam orang), dan **Klaim kantor** (talangan untuk kantor). Di atas tiap tab ada ringkasan total dan progresnya; tiap catatan punya tombol utama (Bayar cicilan, Catat pelunasan, atau Catat pencairan) dan menu **Lainnya** untuk ubah dan hapus.', go: { view: 'debts', label: 'Buka Utang & Piutang' } },
      ...
      { id: 'm-categories', q: 'Kategori', a: 'Kategori dan subkategori per jenis (Pengeluaran, Pemasukan, Tabungan, dan lainnya), lengkap dengan ikon, warna, dan pemakaiannya di siklus ini. Kartu kategori tertutup dulu — ketuk untuk membuka subkategorinya, dan ketuk ikon pensil untuk mengubah. Kategori yang tidak dipakai bisa digabung atau diarsipkan.', go: { view: 'categories', label: 'Buka Kategori' } },
      { id: 'm-settings', q: 'Pengaturan', a: 'Semua pengaturan aplikasi.', children: [
        ...
        { id: 'm-set-security', q: 'Keamanan', keywords: 'ganti password lupa', a: 'PIN 4 angka, buka kunci dengan sidik jari atau wajah (di perangkat yang mendukung), dan ganti password. Saat mengetik password baru terlihat kekuatannya. Lupa password saat ini? Ketuk **Kirim link reset ke email** di kartu Password.', go: { view: 'settings', label: 'Buka Keamanan', target: 'security' } },
        ...
        { id: 'm-set-look', q: 'Tampilan', keywords: 'font huruf inter google sans jakarta tema gelap', a: 'Tema warna, mode terang/gelap, **jenis huruf** (Bawaan, Inter, Google Sans, atau Plus Jakarta Sans), ukuran teks, dan ukuran tampilan (SS sampai L; bawaannya teks S dan tampilan M). Pilihan langsung terlihat dan tersimpan untuk akunmu.', go: { view: 'settings', label: 'Buka Tampilan', target: 'appearance' } },
        ...
        { id: 'm-set-data', q: 'Data & cadangan', a: 'Unduh cadangan seluruh data, atau pulihkan dari file cadangan. **Sinkronkan ulang** memuat ulang semua data dari cloud sekali, jika perangkat ini terasa tidak cocok dengan perangkat lain.', go: { view: 'settings', label: 'Buka Data & cadangan', target: 'data' } },
        { id: 'm-set-about', q: 'Info aplikasi', keywords: 'versi apa yang baru pembaruan changelog', a: 'Versi yang sedang dipakai, kapan terakhir diperbarui, dan daftar **Apa yang baru** di setiap pembaruan. Ada tanda **Baru** di menu Pengaturan sampai halamannya dibuka.', go: { view: 'settings', label: 'Buka Info aplikasi', target: 'about' } },
        { id: 'm-set-reset', q: 'Reset semua data', keywords: 'hapus semua mulai dari awal kosongkan', a: 'Ada di **Pengaturan**, tepat di atas **Keluar dari akun**. Semua catatan keuangan (dompet, kategori, transaksi, anggaran, utang, catatan, dan lainnya) dihapus, lalu panduan awal muncul lagi. Akun, password, nama, dan PIN tetap. Kalau dicentang, pengaturan tampilan, pengingat, Beranda, Insight, dan kontrol keuangan juga kembali ke bawaan. Ketik **RESET** untuk memastikan. Sebaiknya unduh cadangan dulu.', go: { view: 'settings', label: 'Buka Pengaturan' } },
        { id: 'm-set-delete', q: 'Hapus akun', keywords: 'tutup akun hapus permanen', a: 'Juga di **Pengaturan**, di dekat **Keluar dari akun**. Akun dan seluruh datanya dihapus permanen dan tidak bisa dipakai masuk lagi. Masukkan password dan centang persetujuan untuk melanjutkan. Unduh cadangan dulu jika datanya masih ingin disimpan.', go: { view: 'settings', label: 'Buka Pengaturan' } },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'h-claim', q: 'Klaim kantor dari awal sampai cair', a: 'Catat klaim saat kamu menalangi (saldo dompet berkurang). Ketuk langkah status (Draf, Diajukan, Menunggu, Disetujui) untuk menandai prosesnya, dan unggah bukti lewat menu **Lainnya**. Saat kantor mengganti, tekan **Catat pencairan**. Kalau ditolak, pilih **Tolak klaim** di menu Lainnya — nominalnya jadi pengeluaran.', go: { view: 'claims', label: 'Buka Klaim kantor' } },
      ...
      { id: 'h-quick-text', q: 'Mencatat dengan mengetik satu kalimat', keywords: 'ketik cepat otomatis kalimat tulis cepat', a: 'Di **Catat cepat** (tombol +) atau di atas formulir transaksi, ketik misalnya **beli pocari 8rb di alfa**, **gaji 7,5jt masuk bca**, **parkir 5000 kemarin pake tunai**, atau **tf 200rb dari bca ke gopay**, lalu tekan panah. Formulir langsung terisi (nominal, keterangan, tempat, kategori, dompet, tanggal); periksa sebentar lalu **Simpan**. Kategori diambil dari transaksimu sebelumnya atau dari kategori milikmu, tidak pernah membuat kategori baru.' },
      { id: 'h-debt-category', q: 'Kategori untuk bayar utang dan pelunasan piutang', keywords: 'cicilan utang piutang kategori laporan grafik', a: 'Saat **Bayar cicilan** atau **Catat pelunasan**, pilih **Kategori (opsional)**. Pembayaran utang dihitung sebagai pengeluaran dan pelunasan piutang sebagai pemasukan, jadi keduanya muncul di grafik dan laporan kategori. Tanpa kategori, masing-masing tampil sebagai **Bayar utang** atau **Piutang diterima**.' },
      { id: 'h-hide', q: 'Menyembunyikan nominal di layar', keywords: 'mata sembunyikan saldo privasi rahasia angka', a: 'Ketuk ikon **mata** di sebelah kiri lonceng notifikasi. Semua nominal berubah menjadi **Rp•••••** di setiap halaman; ketuk lagi untuk menampilkannya. Pilihan ini diingat di perangkat itu saja, dan isian formulir tetap terlihat saat kamu mengetik.' },
      { id: 'h-notif', q: 'Notifikasi dan riwayat aktivitas', keywords: 'lonceng pemberitahuan pengingat tagihan', a: 'Setiap transaksi, utang, piutang, atau klaim yang disimpan (dan yang dihapus) tercatat di **Riwayat** pada lonceng, lengkap dengan nominal dan dompetnya. **Perlu perhatian** berisi anggaran yang hampir habis, transaksi yang perlu dikonfirmasi, dan tagihan 3 hari ke depan. Agar pengingat muncul sebagai notifikasi HP, nyalakan di **Pengaturan → Pengingat** dan izinkan notifikasi.', go: { view: 'settings', label: 'Buka Pengingat', target: 'reminders' } },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'd-quota', q: 'Apakah aplikasi boros kuota Firestore?', keywords: 'kuota read write hemat biaya firebase gratis sinkron cache', a: 'Tidak. Data disimpan di perangkat; saat aplikasi dibuka hanya data yang berubah yang diunduh, dan laporan, riwayat siklus, serta perpindahan tab dibaca dari perangkat tanpa memakai kuota. Hanya pembukaan pertama di perangkat baru yang mengunduh semuanya sekali.' },
      { id: 'd-insight', q: 'Apakah Insight mengirim dataku ke luar?', a: 'Tidak. Semua analisis Insight dihitung langsung di perangkatmu.' },
      { id: 'd-password', q: 'Lupa password?', keywords: 'reset password atur ulang', a: 'Di halaman masuk, ketuk **Lupa password?** lalu isi username atau email. Link untuk membuat password baru dikirim ke email akun (username dianggap alamat Gmail, mis. rama → rama@gmail.com). Buka link itu, buat password baru, lalu masuk. Cek folder Spam jika emailnya belum terlihat.' },
