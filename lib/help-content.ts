  ...
  },
  {
    ...
    items: [
      ...
      { id: 'm-settings', q: 'Pengaturan', a: 'Semua pengaturan aplikasi.', children: [
        ...
        { id: 'm-set-look', q: 'Tampilan', keywords: 'font huruf inter google sans jakarta tema gelap', a: 'Tema warna, mode terang/gelap, **jenis huruf** (Bawaan, Inter, Google Sans, atau Plus Jakarta Sans), ukuran teks, dan ukuran tampilan. Pilihan langsung terlihat dan tersimpan untuk akunmu.', go: { view: 'settings', label: 'Buka Tampilan', target: 'appearance' } },
